...
/// If type is comparable using its own operator or its conversion operator,
/// then the types operator is used. Otherwise the operation is done via
/// corresponding function from boost/pfr/ops.hpp header.
///
/// \b Example:
/// \code
///     #include <boost/pfr/ops.hpp>
///     struct comparable_struct {      // No operators defined for that
///     structure
...
template <class T>
using enable_hashable_t =
    std::enable_if_t<!not_appliable<hash_detector, const T &, const T &>::value,
                     std::size_t>;
}  // namespace detail

/// \brief Compares lhs and rhs for equality using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{eq_fields}(lhs, rhs).
///
/// \returns true if lhs is equal to rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_eq_comp_t<T, U> eq(const T &lhs,
...
/// \brief Compares lhs and rhs for inequality using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{ne_fields}(lhs, rhs).
///
/// \returns true if lhs is not equal to rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_ne_comp_t<T, U> ne(const T &lhs,
                                                const U &rhs) noexcept {
...
/// \brief Compares lhs and rhs for less-than using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{lt_fields}(lhs, rhs).
///
/// \returns true if lhs is less than rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_lt_comp_t<T, U> lt(const T &lhs,
                                                const U &rhs) noexcept {
...
/// \brief Compares lhs and rhs for greater-than using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{lt_fields}(lhs, rhs).
///
/// \returns true if lhs is greater than rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_gt_comp_t<T, U> gt(const T &lhs,
                                                const U &rhs) noexcept {
...
/// \brief Compares lhs and rhs for less-equal using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{le_fields}(lhs, rhs).
///
/// \returns true if lhs is less or equal to rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_le_comp_t<T, U> le(const T &lhs,
                                                const U &rhs) noexcept {
...
/// \brief Compares lhs and rhs for greater-equal using their own comparison and
/// conversion operators; if no operators available returns
/// \forcedlink{ge_fields}(lhs, rhs).
///
/// \returns true if lhs is greater or equal to rhs; false otherwise
template <class T, class U>
constexpr detail::enable_not_ge_comp_t<T, U> ge(const T &lhs,
                                                const U &rhs) noexcept {
...
/// \brief Hashes value using its own std::hash specialization; if no std::hash
/// specialization available returns \forcedlink{hash_fields}(value).
///
