...
struct equal_to {
  /// \return \b true if each field of \b x equals the field with same index of
  /// \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::eq(x, y); }
...
template <class T = void>
struct not_equal {
  /// \return \b true if at least one field \b x not equals the field with same
  /// index of \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::ne(x, y); }
...
template <class T = void>
struct greater {
  /// \return \b true if field of \b x greater than the field with same index of
  /// \b y and all previous fields of \b x equal to the same fields of \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::gt(x, y); }
...
template <class T = void>
struct less {
  /// \return \b true if field of \b x less than the field with same index of \b
  /// y and all previous fields of \b x equal to the same fields of \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::lt(x, y); }
...
struct greater_equal {
  /// \return \b true if field of \b x greater than the field with same index of
  /// \b y and all previous fields of \b x equal to the same fields of \b y; or
  /// if each field of \b x equals the field with same index of \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::ge(x, y); }
...
struct less_equal {
  /// \return \b true if field of \b x less than the field with same index of \b
  /// y and all previous fields of \b x equal to the same fields of \b y; or if
  /// each field of \b x equals the field with same index of \b y.
  bool operator()(const T &x, const T &y) const { return boost::pfr::le(x, y); }
...
struct hash {
  ...
  std::size_t operator()(const T &x) const { return boost::pfr::hash_value(x); }
};
