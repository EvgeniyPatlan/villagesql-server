...
# VillageSQLExtensionFramework CMake Config — ABI v1
#
# This file is frozen as part of the ABI v1 snapshot. When ABI v2 is
# introduced, this file stays here unchanged so that extensions compiled
# against v1 continue to resolve the correct v1 headers.
#
# Usage:
#   find_package(VillageSQLExtensionFramework REQUIRED)
#
# Set CMAKE_PREFIX_PATH to the stable_sdk/v1/ directory so cmake finds this file.
...
# Walk up to find the prefix (stable_sdk/v1/).
...
get_filename_component(_vef_prefix "${_vef_prefix}" PATH)              # .../  (stable_sdk/v1/)

# Set the include directory to the v1 SDK headers
