...
#define VSQL_MYSQL_SERVICE_REQUIRED_V1_CHANNEL \
  "vsql::mysql_service_required/v1"

#define VSQL_MYSQL_SERVICE_PROVIDED_V1_CHANNEL \
  "vsql::mysql_service_provided/v1"
