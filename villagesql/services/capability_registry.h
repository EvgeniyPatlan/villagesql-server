...
struct CapabilityRegistration {
  ...
  // Called after receive() for each extension that requires this capability.
  // Receives the extension name and the extension_data from the requirement.
